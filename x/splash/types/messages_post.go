...
func NewMsgCreatePost(creator string, title string, body string, media string) *MsgCreatePost {
...
func NewMsgUpdatePost(creator string, id string, title string, body string, media string) *MsgUpdatePost {
