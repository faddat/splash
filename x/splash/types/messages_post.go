...
func NewMsgCreatePost(creator string, title string, body string, jar int32, postwallet string) *MsgCreatePost {
...
func NewMsgUpdatePost(creator string, id string, title string, body string, jar int32, postwallet string) *MsgUpdatePost {
